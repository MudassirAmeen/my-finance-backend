...
<head>
    ...
    <title>Income API Documentation</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h2>1. <code>POST /api/income</code></h2>
        <p><strong>Description:</strong> Retrieve a list of incomes for the authenticated user.</p>
        <h3>Headers:</h3>
        <pre>
        ...
        <p><code>200 OK</code>: A list of incomes for the user.</p>
        <pre><code>{
    "data": [
        {
            "id": 1,
    ...
    "error": "Error details"
        ...
        <h2>2. <code>POST /api/store/income</code></h2>
        <p><strong>Description:</strong> Store a new income record for the authenticated user.</p>
        <h3>Headers:</h3>
        <pre>
            <code>user_id: string (required)</code>
            <code>token: string (required) This is the user's login token.</code>
        ...
        <pre><code>source: string (required)
amount: numeric (required)
description: string (optional)
date: date (optional)</code></pre>
        <p><strong>Response:</strong></p>
        <p><code>200 OK</code>: Income created successfully.</p>
        <pre><code>{
